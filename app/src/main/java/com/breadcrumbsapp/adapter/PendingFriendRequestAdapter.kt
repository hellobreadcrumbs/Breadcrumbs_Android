...
class PendingFriendRequestAdapter(val mContext : Context,
                                  val list : ArrayList<GetFriendsListModel.Message>,
                                  val listener : FriendRequestListener
) : RecyclerView.Adapter<PendingFriendRequestAdapter.VH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_pending_friend_request, parent, false)
        return VH(itemView)
    }
